    ...
    <div class="container">
        ...
        <div id="perInfo1" class="personal_Info clearfix" v-show='perInfo1'>
            ...
            <div class="left">
                ...
                <div class="aux_Info ">
                    <p class="clearfix">
                        <span class="myIdentity">{{identity}}</span>
                        <span class="divider"></span>
                        <span class="edu_Record">{{record}}</span>
                        <span class="divider"></span>
                        <span class="job_status">{{state}}</span>
                    </p>
                    <p class="clearfix">
        ...
        <div id="perInfo2" class="edit_personalInfo" v-show='perInfo2'>
            ...
            <div class="per_info clearfix" action="">
                ...
                <div class="edit_name box1">
                    <div>姓名</div>
                    <div>
                        <input class="input" name="pname" id="name" type="text" placeholder="请输入您的姓名" v-model="name">
                    </div>
                </div>
                <!--编辑求职状态-->
                ...
                <div class="edit_sex box1">
                    ...
                    <div>
                        <p>
                            <!-- 隐示关联 -->
                            <label v-for='i in sex' :class='$index == index?"active_sex":""' @click="fn1($index)"
                                   id="male">
                ...
                <div class="edit_identity box1">
                    <div>我的身份</div>
                    <div>
                        <select name="pidentity" v-model="identity">
                ...
                <div class="edit_weChat box1">
                    <div>微信号(选填)</div>
                    <div>
                        <input id="weChat" name="pwe_chat" type="text" placeholder="请输入您的微信号" v-model="weChat">
                    </div>
                </div>
                <!--编辑手机号-->
                <div class="edit_phone box1">
                    <div>手机号</div>
                    <div>
                        <input id="tel" name="ptel" type="text" placeholder="请输入您的手机号" v-model="phone">
                    </div>
                </div>
                <!--编辑邮箱-->
                <div class="edit_email box1">
                    <div>邮箱</div>
                    <div>
                        <input id="email" name="pemail" type="text" placeholder="请输入您的邮箱" v-model="email">
                    </div>
                </div>
                <!--操作区域-->
        ...
        <div id="expInfo1" class="expected" v-show='expInfo1'>
            ...
            <div class="required clearfix">
                <span>{{expectPosition}}</span>
                <span class="divider"></span>
                <span>{{salaryLeft+'-'+salaryRight}}</span>
                <span class="divider"></span>
                <span>{{industry}}</span>
                <span class="divider"></span>
                <span>{{city}}</span>
        ...
        <div id="expInfo2" class="edit_expectedInfo" v-show='expInfo2'>
            ...
            <div class="exp_info clearfix" action="">
                ...
                <div class="edit_expPos box1">
                    <div>期望职位</div>
                    <div>
                        <select name="eep" v-model="expectPosition">
                ...
                <div class="edit_salary box1">
                    ...
                    <div>
                        <!-- 最低薪资 -->
                        <select class="selSalary" name="esal_min" id="sal1" v-model="salaryLeft">
                        ...
                        <!-- 最高薪资 -->
                        <select class="selSalary" name="esal_max" id="sal2" v-model="salaryRight">
                            <option value="8k">8k</option>
                            <option value="9k">9k</option>
                            <option value="10k">10k</option>
                            <option value="11k">11k</option>
                ...
                <div class="edit_industry box1">
                    <div>行业</div>
                    <div>
                        <select name="eindustry" v-model="industry">
                ...
                <div class="edit_city box1">
                    <div>城市</div>
                    <div>
                        <select name="ecity" v-model="city">
        ...
        <div id="interInfo1" class="internship clearfix" v-show='interInfo1'>
            ...
            <div class="main">
                ...
                <div class="company clearfix">
                    <h3>{{company}}</h3>
                    <span class="time">{{workLeft+' 至 '+workRight}}</span>
                ...
                <div class="content clearfix">
                    ...
                    <span class="text">{{jobContent}}</span>
                </div>
                <!--业绩-->
                <div class="performance clearfix">
                    <span class="type">业绩:</span>
                    <span class="text">{{workPerformance}}</span>
                </div>
            </div>
        </div>
        <!--添加实习经历-->
        <div id="interInfo2" class="new_internship" v-show='interInfo2'>
            ...
            <div class="internship_newInfo clearfix" action="">
                ...
                <div class="new_companyName box1">
                    <div>公司名称</div>
                    <div>
                        <input name="icn" type="text" placeholder="例如:南京正厚软件技术有限公司" v-model="company">
                    </div>
                </div>
                <!--所属行业-->
                ...
                <div class="new_department box1">
                    <div>所属部门(选填)</div>
                    <div>
                        <input name="idepartment" type="text" placeholder="例如:开发部" v-model="department">
                    </div>
                </div>
                <!--职位名称-->
                ...
                <div class="new_positionType box1">
                    <div>职位类型</div>
                    <div>
                        <select name="ipt" v-model="positionType">
                ...
                <div class="new_workingTime box1">
                    ...
                    <div>
                        <!-- 工作开始时间 -->
                        <input name="iwork_ft" class="oldTime" type="date" v-model="workLeft">
                        <span class="zhi">至</span>
                        <!-- 工作结束时间 -->
                        <input name="iwork_lt" class="newTime" type="date" v-model="workRight">
                    </div>
                </div>
                <!--工作内容-->
                <div class="new_jobContent box1">
                    <div>工作内容</div>
                    <div>
                        <textarea name="ijc" cols="92" rows="8" placeholder="输入工作内容" v-model="jobContent"></textarea>
                    </div>
                </div>
                <!--工作业绩-->
                <div class="new_workPerformance box1">
                    <div>工作业绩(选填)</div>
                    <div>
                        <textarea name="iwp" cols="92" rows="8" placeholder="输入工作业绩"
                                  v-model="workPerformance"></textarea>
                    </div>
                </div>
                <!--隐式关联-->
        ...
        <div id="project1" class="project" v-show='project1'>
            ...
            <div class="main">
                ...
                <div class="projectName clearfix">
                    <h3>{{projectName}}</h3>
                    <span class="time">{{projectLeft+' 至 '+projectRight}}</span>
                ...
                <div class="role">
                    <h3 class="clearfix">
                        <span class="projectRole">{{role}}</span>
                    </h3>
                </div>
                <!--内容-->
                <div class="content clearfix">
                    <span class="type">内容:</span>
                    <span class="text">{{projectContent}}</span>
                </div>
                <!--业绩-->
                <div class="performance clearfix">
                    <span class="type">业绩:</span>
                    <span class="text">{{projectPerformance}}</span>
                </div>
                <!--项目链接-->
        ...
        <div id="project2" class="new_project" v-show='project2'>
            ...
            <div class="project_newInfo clearfix">
                ...
                <div class="new_projectName box1">
                    <div>项目名称</div>
                    <div>
                        <input name="pname2" type="text" placeholder="例如:直聘网" v-model="projectName">
                    </div>
                </div>
                <!--项目角色-->
                <div class="new_role box1">
                    <div>项目角色</div>
                    <div>
                        <input name="prole" type="text" placeholder="例如:Java开发工程师" v-model="role">
                    </div>
                </div>
                <!--项目链接-->
                <div class="new_link box1">
                    <div>项目链接(选填)</div>
                    <div>
                        <input name="plink" type="text" placeholder="例如:github.com/erik" v-model="link">
                    </div>
                </div>
                <!--项目时间-->
                <div class="new_projectTime box1">
                    ...
                    <div>
                        <!-- 项目开始时间 -->
                        <input name="pdev_ft" class="oldTime" type="date" v-model="projectLeft">
                        <span class="zhi">至</span>
                        <!-- 项目结束时间 -->
                        <input name="pdev_lt" class="newTime" type="date" v-model="projectRight">
                    </div>
                </div>
                <!--项目内容-->
                <div class="new_projectContent box1">
                    <div>项目内容</div>
                    <div>
                        <textarea name="pcon" cols="92" rows="8" placeholder="输入工作内容"
                                  v-model="projectContent"></textarea>
                    </div>
                </div>
                <!--工作业绩-->
                <div class="new_projectPerformance box1">
                    <div>项目业绩(选填)</div>
                    <div>
                        <textarea name="pperf" cols="92" rows="8" placeholder="输入工作业绩"
                                  v-model="projectPerformance"></textarea>
                    </div>
                </div>
                <!--操作区域-->
                <div class="edit_operation">
        ...
        <div id="education1" class="education" v-show='education1'>
            ...
            <div class="main">
                ...
                <div class="schoolName clearfix">
                    <h3>{{schoolName}}</h3>
                    <span class="time">{{eduLeft+' 至 '+eduRight}}</span>
                ...
                <div class="experience clearfix">
                    <span class="text">{{schoolExperience}}</span>
                </div>
        ...
        <div id="education2" class="new_education" v-show='education2'>
            ...
            <div class="education_newInfo clearfix">
                ...
                <div class="new_schoolName box1">
                    <div>学校名称</div>
                    <div>
                        <input name="eschName" type="text" placeholder="例如:北京大学" v-model="schoolName">
                    </div>
                </div>
                <!--学历-->
                <div class="new_record box1">
                    <div>学历</div>
                    <div>
                        <select name="erecord" v-model="record">
                ...
                <div class="new_major box1">
                    <div>专业</div>
                    <div>
                        <input name="emajor" type="text" placeholder="例如:计算机科学与技术" v-model="major">
                    </div>
                </div>
                <!--时间段-->
                <div class="new_schoolTime box1">
                    ...
                    <div>
                        <!-- 教育开始时间 -->
                        <input name="edu_ft" class="oldTime" type="date" v-model="eduLeft">
                        <span class="zhi">至</span>
                        <!-- 教育结束时间 -->
                        <input name="edu_lt" class="newTime" type="date" v-model="eduRight">
                    </div>
                </div>
                <!--在校经历-->
                <div class="new_schoolExperience box1">
                    <div>在校经历(选填)</div>
                    <div>
                        <textarea name="eexp" cols="92" rows="8" placeholder="请填写内容"
                                  v-model="schoolExperience"></textarea>
                    </div>
                </div>
                <!--操作区域-->
                <div class="edit_operation">
        ...
        <div id="certificate1" class="certificate" v-show='certificate1'>
            ...
            <div class="main">
                ...
                <div class="certificateName">
                    <div class="certificateInfo clearfix">
                        <span class="certificateName_type">英语:{{english}}</span>
                        <span class="certificateName_type">IT:{{it}}</span>
                        <span class="certificateName_type">会计:{{account}}</span>
                        <span class="certificateName_type">精算:{{actuary}}</span>
                        <span class="certificateName_type">金融:{{finance}}</span>
                        <span class="certificateName_type">法律:{{law}}</span>
                    </div>
        ...
        <div id="certificate2" class="new_certificate" v-show='certificate2'>
            ...
            <div class="certificate_newInfo clearfix">
                ...
                <div class="new_eh box1">
                    <div>英语类</div>
                    <div>
                        <select name="cenglish" v-model="english">
                            <option value="暂无">暂无</option>
                            <option value="大学英语四级">大学英语四级</option>
                            <option value="大学英语六级">大学英语六级</option>
                            <option value="英语专业八级">英语专业八级</option>
                            <option value="雅思学术类高分者">雅思学术类高分者</option>
                            <option value="托福网考高分者">托福网考高分者</option>
                        </select>
                    </div>
                </div>
                <!--IT类-->
                <div class="new_it box1">
                    <div>IT类</div>
                    <div>
                        <select name="cit" v-model="it">
                            <option value="暂无">暂无</option>
                            <option value="计算机等级考试">计算机等级考试</option>
                            <option value="RHCE红帽认证">RHCE红帽认证</option>
                            <option value="HCIE华为认证">HCIE华为认证</option>
                            <option value="ACP阿里云认证">ACP阿里云认证</option>
                            <option value="计算机专业技术资格">计算机专业技术资格</option>
                        </select>
                    </div>
                </div>
                <!--会计类-->
                <div class="new_account box1">
                    <div>会计类</div>
                    <div>
                        <select name="caccount" v-model="account">
                            <option value="暂无">暂无</option>
                            <option value="会计从业资格证">会计从业资格证</option>
                            <option value="会计职称">会计职称</option>
                            <option value="CPA中国注册会计师">CPA中国注册会计师</option>
                            <option value="AICPA美国注册会计师">AICPA美国注册会计师</option>
                            <option value="AIA国际会计师">AIA国际会计师</option>
                        </select>
                    </div>
                </div>
                <!--精算类-->
                <div class="new_actuary box1">
                    <div>精算类</div>
                    <div>
                        <select name="cactuary" v-model="actuary">
                            <option value="暂无">暂无</option>
                            <option value="中国精算师">中国精算师</option>
                            <option value="SOA北美精算师">SOA北美精算师</option>
                            <option value="英国精算师">英国精算师</option>
                        </select>
                    </div>
                </div>
                <!--金融类-->
                <div class="new_financial box1">
                    <div>金融类</div>
                    <div>
                        <select name="cfinance" v-model="finance">
                            <option value="暂无">暂无</option>
                            <option value="证券从业资格证">证券从业资格证</option>
                            <option value="ChFP国家理财规划师">ChFP国家理财规划师</option>
                            <option value="CFA特许金融分析师">CFA特许金融分析师</option>
                            <option value="税务师">税务师</option>
                            <option value="银行从业资格证">银行从业资格证</option>
                            <option value="FRM金融风险管理师">FRM金融风险管理师</option>
                            <option value="CFC注册财务顾问师">CFC注册财务顾问师</option>
                        </select>
                    </div>
                </div>
                <!--法律类-->
                <div class="new_law box1">
                    <div>法律类</div>
                    <div>
                        <select name="claw" v-model="law">
                            <option value="暂无">暂无</option>
                            <option value="律师执业证">律师执业证</option>
                            <option value="法律职业资格证">法律职业资格证</option>
                        </select>
                    </div>
                </div>
                <!--操作区域-->
        ...
        <div id="advantage1" class="advantage" v-show='advantage1'>
            ...
            <div class="main">
                <!--内容-->
                <div class="content clearfix">
                    <div class="advantage_info">{{advantage}}</div>
        ...
        <div id="advantage2" class="edit_advantage" v-show='advantage2'>
            ...
            <div class="advantage_editInfo clearfix">
                ...
                <div class="edit_perAdvantage box1">
                    <div>
                    <textarea name="advantage" cols="92" rows="8"
                              placeholder="例如:两年Java开发经验，熟悉Spring框架，对代码有一定程度的自我理解。" v-model="advantage"></textarea>
                    </div>
                </div>
                <!--操作区域-->
                <div class="edit_operation">
